...
x_train_flat = 2*x_train_flat - 1  # normalizar a [-1,1]
x_test_flat  = preprocess_dense(x_test)
x_test_flat = 2*x_test_flat - 1  # normalizar a [-1,1]
...
x = layers.Dense(512, activation="tanh")(encoder_input)
...
x = layers.Dense(128, activation="tanh")(decoder_input)
x = layers.Dense(256, activation="tanh")(x)
...
# Callbacks
# -------------------------
os.makedirs("./tanh/checkpoint", exist_ok=True)
os.makedirs("./tanh/logs", exist_ok=True)
model_checkpoint_callback = callbacks.ModelCheckpoint(
    filepath="./tanh/checkpoint/checkpoint.keras",
...
tensorboard_callback = callbacks.TensorBoard(log_dir="./tanh/logs")
...
# Saving models
# -------------------------
os.makedirs("./tanh/models", exist_ok=True)
autoencoder.save("./tanh/models/autoencoder_dense.keras")
encoder.save("./tanh/models/encoder_dense.keras")
decoder.save("./tanh/models/decoder_dense.keras")
