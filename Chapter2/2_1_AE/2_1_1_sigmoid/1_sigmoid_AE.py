...
x = layers.Dense(512, activation="sigmoid")(encoder_input)
...
decoder_output = layers.Dense(IMAGE_SIZE*IMAGE_SIZE, activation="sigmoid", name="decoder_output")(x)
...
# Callbacks
# -------------------------
os.makedirs("./sigmoid/checkpoint", exist_ok=True)
os.makedirs("./sigmoid/logs", exist_ok=True)
model_checkpoint_callback = callbacks.ModelCheckpoint(
    filepath="./sigmoid/checkpoint/checkpoint.keras",
...
tensorboard_callback = callbacks.TensorBoard(log_dir="./sigmoid/logs")
...
# Saving models
# -------------------------
os.makedirs("./sigmoid/models", exist_ok=True)
autoencoder.save("./sigmoid/models/autoencoder_dense.keras")
encoder.save("./sigmoid/models/encoder_dense.keras")
decoder.save("./sigmoid/models/decoder_dense.keras")
